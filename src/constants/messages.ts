...
const JA = {
  ...
  groupPromptDescription: '所属する組織が設定されていません。組織を選択してください。',
  groupPromptSelect: '組織を選択',
...
const EN: Partial<MessageCatalog> = {
  ...
  groupPromptDescription: 'Your organization is not set. Please select your organization.',
  groupPromptSelect: 'Select Organization',
